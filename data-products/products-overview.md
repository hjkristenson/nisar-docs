...
The NASA processing levels used for SAR have somewhat different meanings than those used for multi-spectral (optical) imagery. These processing levels and the specific products generated at each level are summarized here.
